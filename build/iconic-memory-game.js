...
var _user$project$Main$showGrid = function (model) {
	var tileStyle = _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					{ctor: '_Tuple2', _0: 'flex', _1: '1 1 50%'},
					{ctor: '_Tuple2', _0: 'height', _1: '50%'}
				]))
		]);
	var rowStyle = _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
						...
						_elm_lang$core$List$concat(
							_elm_lang$core$Native_List.fromArray(
								[
									...
									[
										A2(
										_user$project$Main$getMarker,
										model.indicateRow && _elm_lang$core$Native_Utils.eq(
											model.seekRow,
											_elm_lang$core$Basics$fst(indexedRow)),
										'>')
									]),
									A2(
									_elm_lang$core$List$concatMap,
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														model.showLetters ? _elm_lang$core$String$fromList(
															_elm_lang$core$Native_List.fromArray(
																[letter])) : '_')
													]))
											]);
									},
									_elm_lang$core$Basics$snd(indexedRow)),
									_elm_lang$core$Native_List.fromArray(
									[
										A2(
										_user$project$Main$getMarker,
...
var _user$project$Main$collate = F2(
	function (n, xs) {
		...
		if (_p0.ctor === '[]') {
			...
			return A2(
				...
				_p0,
				A2(
					_user$project$Main$collate,
					n,
					A2(_elm_lang$core$List$drop, n, xs)));
		}
	});
var _user$project$Main$generateNewGrid = F2(
	function (grid, cols) {
		return A2(
			_user$project$Main$collate,
			cols,
			A2(
				_elm_lang$core$List$map,
				function (i) {
					return _elm_lang$core$Char$fromCode(65 + i);
				},
				grid));
	});
...
var _user$project$Main$SpeedUp = {ctor: 'SpeedUp'};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						{ctor: '_Tuple2', _0: 'margin-top', _1: '10%'}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$showGrid(model),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_elm_lang$html$Html$text('Show time (ms):'),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$SpeedDown)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('-')
				...
				_elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.showTime)),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$SpeedUp)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('+')
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_elm_lang$html$Html$text('Prompt delay (ms):'),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$DelayDown)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('-')
				...
				_elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.delay)),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$href('http://github.com/DestyNova/iconic-memory-game')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
